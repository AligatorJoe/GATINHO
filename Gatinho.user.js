        ...
        $("#dio_tools").click(function () {
            ...
            if (!$('#dio_settings').get(0)) {
                ...
                $('.settings-container').append(
                    ...
                    '<li><a class="submenu_link" href="#" id="dio_test"><span class="left"><span class="right"><span class="middle">' + getText("settings", "cat_them") + '</span></span></span></a></li>' +
                    '</ul>' +
                    ...
                    '<DIV class="content">' +
                                            ...
                                            // Units test
                    '<table id="dio_test_table" class="content_category"><tr>' +
                                                ...
                                                '</div>' +
                                                '<td><div id="dio_them" class="checkbox_new"><div class="cbx_icon"></div><div class="cbx_caption">' + getText("options", "test")[0] + '</div></div>' +
                   ...
                   ((Browser !== "Firefox","MSIE","Trident","Edge","Chrome","Safari", "Android", "Opera") ? ('<tr>' +
                                             ...
                                             /*   '<div class="fond">' +
                                               ...
                                               '<table width="580px" cellpadding="0" cellspacing="0" id="scrollbar" width="90%" class="radiobutton horizontal rbtn_visibility" style="display:none;"><tr>'+
                                                ...
                                                '<td><img src="https://grmh.pl/i/240.gif";/></td>' +
                                                '</tr></td>'+
                                                '<td width="20%"><div class="option js-option" id="dio_ta"><div class="pointer"></div><strong>'+ getText("options", "Blue") +'</strong></div></td>'+
                                                '<td width="20%"><div class="option js-option" id="dio_tb"><div class="pointer"></div><strong>'+ getText("options", "Red") +'</strong></div></td>'+
                                                '<td width="20%"><div class="option js-option" id="dio_tc"><div class="pointer"></div><strong>'+ getText("options", "Purple") +'</strong></div></td>'+
                                                '<td width="20%"><div class="option js-option" id="dio_td"><div class="pointer"></div><strong>' + getText("options", "Yellow") + '</strong></div></td>'+
                                                '<td width="20%"><div class="option js-option" id="dio_te"><div class="pointer"></div><strong>' + getText("options", "Pink") + '</strong></div></td>'+
                                                '</tr></td>'+
                                                '<td><img src="https://grmh.pl/i/240.gif";/></td>' +
                                                '</tr></td>'+
                                                ...
                                                '<td><img src="https://grmh.pl/i/240.gif";/></td>' +
                                                '</tr></td>'+
                                                '<td width="20%"><div class="option js-option" id="dio_tf"><div class="pointer"></div><strong>'+ getText("options", "Halloween") +'</strong></div></td>'+
                                                '<td width="20%"><div class="option js-option" id="dio_tg"><div class="pointer"></div><strong>'+ getText("options", "Christmas") +'</strong></div></td>'+
                                                '<td width="20%"><div class="option js-option" id="dio_th"><div class="pointer"></div><strong>'+ getText("options", "Dead") +'</strong></div></td>'+
                                                '<td width="20%"><div class="option js-option" id="dio_ti"><div class="pointer"></div><strong>' + getText("options", "Abes") + '</strong></div></td>'+
                                                '<td width="20%"><div class="option js-option" id="dio_tj"><div class="pointer"></div><strong>' + getText("options", "Groot") + '</strong></div></td>'+
                                                '</tr></table></td>'+
                                                '</tr>' ) : "") +
                    '<tr>' +
                ...
                $('#dio_settings .radiobutton .option').click(function(){
                    ...
                    DATA.options.dio_ta = false;
                    DATA.options.dio_tb = false;
                    DATA.options.dio_tc = false;
                    DATA.options.dio_td = false;
                    DATA.options.dio_te = false;
                    DATA.options.dio_tf = false;
                    DATA.options.dio_tg = false;
                    DATA.options.dio_th = false;
                    DATA.options.dio_ti = false;
                    DATA.options.dio_tj = false;
                    $(this).toggleClass("checked").toggleClass("disabled").toggleClass("green");
                    toggleActivation(this.id);

                    DATA.options[this.id] = $(this).hasClass("checked");
                    saveValue("options", JSON.stringify(DATA.options));
                    if (DATA.options.dio_them){
        ...
        init: function () {
            ...
            if (notif <= 20) {
                ...
                var NotifText = '<div id="NotifText">' +
                    ...
                    '<p><span style="font-size:21px;">&nbsp;➫ New Blog Dio-Tools-Gatinho</span><br/>' +
                    '&nbsp;- To start this year 2021 Dio-Tools-Gatinho created his blog Dio-Tools, at the moment the description of the modules<br/>' +
                    '&nbsp; is available with some explanations and the history of dio-tools ➫ (<a href="https://mycitygre.000webhostapp.com/Dio-Tools/index.html" target="_blank">Blog Dio-Tools</a>)<br/>' +
                    '&nbsp;- The older versions were obsolete until 28/07/2021.<br/>' +
                    '<p><span style="font-size:12px;">&nbsp;➫ New toutes les version Dio Tools son disponible ici➫ (<a href="https://mycitygre.000webhostapp.com/Dio-Tools/index.html" target="_blank">Blog Dio-Tools</a>)</span><br/>' +
                    ...
                    '<a id="link_contact" href=' + getText("link", "forum") + ' target="_blank">Dio Tools Gatinho</a></span>' +
    ...
    var TownPopup = {
        activate : function(){
            ...
            $('<style id="dio_town_popup_style" type="text/css">' +
                ...
                // fury Icon
                '#dio_town_popup .fury_icon { width:22px; height:15px; background: url(https://wiki.en.grepolis.com/images/thumb/a/ab/Fury_icon.png/30px-Fury_icon.png) no-repeat; margin-left:2px; display: inline-block; vertical-align: middle; background-size: 95%;} ' +
    ...
    var TransportCapacity = {
        activate: function () {
            ...
            $('<div id="transporter" class="cont" style="height:25px;">' +
                ...
                '<td><img id="ship_pop" class="ico" src="https://gpall.innogamescdn.com/images/game/res/pop.png" width="21px" height="Auto"></td>' +//image pop addicionee 29/07/2021
                '<td><span id="ship" class="bold text_shadow" style="color:#FFCC66;font-size: 10px;line-height: 2.1;"></span></td>' +
                '<td><img id="ship_img" class="ico" src="https://i.imgur.com/vIhorz8.png"></td>' +//deplacement de l image Ship 29/07/2021
                '</tr></table>' +
...
//($('#f_R22').hasClass("checked") ? '[color=#08781C][size=9][i][b]' + getText("labels", "R2") + '[/b][/i][/size][/color]' + '[color=#28045A][size=8][i][b]' + ( "  🕐🕑:🕒🕓:🕔🕕" ) + '[/b][/i][/size][/color]\n' : ' ')+
    ...
    var FavorPopup = {
        ...
        activate: function () {
            ...
            $('<div id="dio_FavorPopup" style="width: 80px; height: 35px; position: absolute !important; left: 75px; top: 2px;"></div>').appendTo('.gods_favor_amount');
            // segunda visualisacao dos favores dio_FavorPopup2
            $('<div id="dio_FavorPopup2" style="width: 80px; height: 70px; position: absolute !important; left: 20px; top: -65px;"></div>').appendTo('.gods_favor_amount');
        ...
        deactivate: function () {
            ...
            $('#dio_FavorPopup2').remove();
            $('#dio_FuryPopup').remove();
            $('#dio-amount').remove();
        },
        //caixa popup quantidades favores abaixo dos mini deus
        setFavorPopup: function () {
            ...
            $('#dio_FavorPopup2').tooltip(tooltip_str);
    ...
    var Spellbox = {
        ...
        activate: function () {
            ...
            $('<style id="dio_spellbox_style" type="text/css">' +
               ...
               // '.gods_spells_menu.ui-draggable {  margin-left: 227%; } ' +
        ...
        change: function () {
            ...
            // Change spell order
            //$('#ui_box .god_container[data-god_id="zeus"]').prependTo('#ui_box .gods_spells_menu .content');
            //$('#ui_box .god_container[data-god_id="poseidon"]').prependTo('#ui_box .gods_spells_menu .content');
            //$('#ui_box .god_container[data-god_id="hera"]').prependTo('#ui_box .gods_spells_menu .content');
            //$('#ui_box .god_container[data-god_id="atena"]').prependTo('#ui_box .gods_spells_menu .content');
            //$('#ui_box .god_container[data-god_id="hades"]').prependTo('#ui_box .gods_spells_menu .content');
            ...
            //$('#ui_box .god_container[data-god_id="ares"]').prependTo('#ui_box .gods_spells_menu .content');
        }
