...
/*******************************************************************************************************************************
 * change of hosting 17/09/2021
 * As of today the script has been allocated on github.com, along with the license GNU General Public License v3.0
 *******************************************************************************************************************************/
//Style JoeMan
    ...
    function addForm(e) {
        ...
        $('<div class="bb_def_chooser">' +
           ...
           // '<div id="f_mov" class="checkbox_new "><div class="cbx_icon"></div><div class="cbx_caption">' + getText("labels", "mov") + '</div></div><br><br>' +
            ...
            '<div id="f_R000" class="checkbox_new"><div class="cbx_icon"></div><div class="cbx_caption"><input id="inText" type="time" name="appt-time" step="2" />' + getText("labels", "f_R210") + '</div></div><br><br>' +
       ...
       //bireme1 = uw.Game.nBonus
        ...
        $(bbcodeBarId + ' #dio_insert').click(function () {
            ...
            var str = '[center]' + '[font=serif]' + '\n\n[color=#07701B][size=18][u][b]' + getText("labels", "ttl") + ' [/b][/u][/size][/color]\n' + '[/font]' + '[/center]' +
                ...
                ($('#f_R000').hasClass("checked") ? '[center][size=7]' + OC2 + '[/size][/center]' : ' ') +
...
//($('#f_R22').hasClass("checked") ? '[color=#08781C][size=9][i][b]' + getText("labels", "R2") + '[/b][/i][/size][/color]' + '[color=#28045A][size=8][i][b]' + ( "  🕐🕑:🕒🕓:🕔🕕" ) + '[/b][/i][/size][/color]\n' : ' ')+
                '[size=7][url=https://mycitygre.000webhostapp.com/Dio-Tools/index.html[/url] - (v' +'\u00a0'+ version + ')' + '[/size]\n' ;
        ...
        activate: function() {
            try {
                ...
                $("#dio_messageExport").click(function () {
                    ...
                    bb_content += "[url=https://github.com/AligatorJoe/Dio-Tools-2019/raw/master/Gatinho.user.js]DIO-TOOLS[/url] - v."+ version;
                    bb_content += "[/quote]";
        ...
        NewYear : {
            add : function(){
                ...
                $('<a href="http://www.greensmilies.com/smilie-album/" target="_blank"><div id="dio_newYear">'+
                    '<img src="https://i.imgur.com/RJMgQk9.gif">' + //(2) ano 2022
                    '<img src="https://i.imgur.com/VS5DRM3.gif">' + //(0)
                    '<img src="https://i.imgur.com/RJMgQk9.gif">' + //(2)
                    '<img src="https://i.imgur.com/RJMgQk9.gif">' + //(2)
