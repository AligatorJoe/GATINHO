...
/*******************************************************************************************************************************
 * Global stuff ultima versao 07/05/2021
 *button resorce maravilhas: edeport du buton ver la droite
 *
 *
 *
 *******************************************************************************************************************************/
...
function DIO_GAME(version, gm, DATA, time_a) {
    var MutationObserver = uw.MutationObserver || window.MutationObserver,
        ...
        dio_sprite = "https://i.imgur.com/HQq4rV1.png";//"https://i.imgur.com/cILbyDs.png";
        dio_icon = '<img src="https://i.imgur.com/bW8lxNz.gif" style="width: 15px;float:left;margin: 1px 4px 0px -3px">';
    ...
    var LANG = {
        de: {
            link: {
                Update:	"https://greasyfork.org/fr/scripts/395523-dio-tools-gatinho/versions",
                contact: "http://grepotemas.blogspot.com/",
                forum: "http://grepotemas.blogspot.com/",
                UnitComparison:	"https://wiki.en.grepolis.com/wiki/Units_Portal/"
           },
            settings: {
                dsc: "DIO-Tools bietet, unter anderem, einige Bildschirme, ein Smiley-Box, Handel mit Optionen	<br> und einige Änderungen im Layout.",
            ...
            options: {
                // bir:["Zähler Birremes", "Konto der Stadt Biremen in der Stadt"],
                ...
                // cha: ["Tee", "Ersetzt den Chat als IRC-Chat."],
                ...
                // GrepotemasThemes
                Ths: ["Blue", "Ändern Sie die Farbe Thema, schalte nicht mehr als ein Thema zu einer Zeit!"],
                Thy: ["yellow"],
                Thr: ["Red"],
                Thk: ["Pink"],
                Thf: ["purple"],
            ...
            buttons: {
                sav: "Speichern", ins: "Speichern", res: "Reset"
           }
       },
      ///////////////////////////////////////////
    ...
    ///////////////////////////////////////////
        it: {
            ...
            settings: {
                dsc: "DIO-Tools offre, tra le altre cose, alcune schermate, una scatola smiley, trading di opzioni	<br> e alcuni cambiamenti nel layout.",
            ...
            options: {
                // bir:["Contatore Birremes", "Conto delle biremi città in città"],
                ...
                // cha: ["Tè", "Ha sostituito la chat come una chat IRC."],
                ...
                // GrepotemasThemes
                Ths: ["Blue", "Cambiare il tema del colore, non attivare più di un argomento alla volta!"],
                Thy: ["yellow"],
                Thr: ["Red"],
                Thk: ["Pink"],
                Thf: ["purple"],
            ...
            buttons: {
                sav: "Salvare", ins: "Inserire", res: "Ripristina"
           }
       },
      ///////////////////////////////////////////
    ...
    ///////////////////////////////////////////
        ...
        el: {//GR?
            ...
            options: {
                // bir:["Μετρητής Birremes", "Υπόψη τις διήρεις πόλη στην πόλη"],
                ...
                // cha: ["Τσάι", "Αντικατέστησε τη συζήτηση ως IRC chat."],
                ...
                // GrepotemasThemes
                Ths: ["Blue", "Αλλαγή του θέματος χρώματος, Μην ενεργοποιήσετε περισσότερα από ένα θέμα σε μια στιγμή!"],
                Thy: ["yellow"],
                Thr: ["Red"],
                Thk: ["Pink"],
                Thf: ["purple"],
            ...
            buttons: {
                sav: "Να σώσω", ins: "Εισάγετε", res: "Επαναφορά"
           }
       },
      ////////////////////////////////////////////////
     //  Néerlandais (NL) Translation by  JoeMan   //
    ////////////////////////////////////////////////
        dk: { //DL?
            link: {
                Update:"https://greasyfork.org/fr/scripts/395523-dio-tools-gatinho/versions",
            ...
            settings: {
                dsc: "DIO-Tools biedt, onder andere, sommige schermen, een smiley box, handel in opties<br> en een aantal wijzigingen in de lay-out.",
            ...
            options: {
                // bir:["Counter Birremes", "Rekening de stad biremes in de stad"],
                ...
                // cha: ["Thee", "Vervangen van de chat als een IRC-chat."],
                ...
                Exi: ["eis:", "💰  Activeren ->"],
                // GrepotemasThemes
                Ths: ["Blue", "Verander de kleur thema, niet activeert meer dan één onderwerp per keer!"],
                Thy: ["yellow"],
                Thr: ["Red"],
                Thk: ["Pink"],
                Thf: ["purple"],
    ...
    ///////////////////////////////////////////
         ...
         en: {
            ...
            settings: {
                dsc: "DIO-Tools offers, among other things, some screens, one smiley box, options trading<br> and some changes in the layout.",
            ...
            options: {
                // bir:["Counter Birremes", "Account the city biremes in town"],
                ...
                // cha: ["Tea", "Replaced the chat as an IRC chat."],
                ...
                // GrepotemasThemes
                Ths: ["Blue", "Change the color theme, Do not activate more than one topic at a time!"],
                Thy: ["yellow"],
                Thr: ["Red"],
                Thk: ["Pink"],
                Thf: ["purple"],
            ...
            buttons: {
                sav: "To save", ins: "Insert", res: "Reset"
           }
       },
        ...
        fr: {
            ...
            settings: {
                dsc: "offres DIO-outils, entre autres, certains écrans, une boîte de smiley, la négociation d'options<br> et quelques changements dans la mise en page.",
            ...
            options: {
                // bir:["contre Birremes", "La ville compte birèmes en ville"],
                ...
                // cha: ["thé", "Remplacée le chat comme un chat IRC."],
                ...
                // GrepotemasThemes
                Ths: ["Blue", "Changer le thème de couleur, ne pas activer plus d'un sujet à la fois!"],
                Thy: ["yellow"],
                Thr: ["Red"],
                Thk: ["Pink"],
                Thf: ["purple"],
            ...
            buttons: {
                sav: "Sauver", ins: "Insérer", res: "Réinitialiser"
           }
       },
          ///////////////////////////////////////////////////
       ...
       ru: {
            ...
            settings: {
                dsc: "DIO-Tools предлагает, кроме всего прочего, некоторые экраны, один смайлик коробка, торговли опционами<br> и некоторые изменения в макете.",
            ...
            options: {
                // bir:["Счетчик Birremes", "Счет городских бирем в городе"],
                ...
                // cha: ["Чай", "Заменил чат как IRC-чат."],
                ...
                // GrepotemasThemes
                Ths: ["Вlue", "Изменить цветовую тему, не активировать более одной темы, в то время!"],
                Thy: ["yellow"],
                Thr: ["Red"],
                Thk: ["Pink"],
                Thf: ["purple"],
            ...
            buttons: {
                sav: "Сохранить", ins: "Вставить", res: "Сброс"
           }
       },
          ///////////////////////////////////////////////////
        ...
        pl: {
            ...
            settings: {
                dsc: "DIO-Tools oferuje między innymi niektóre ekrany, jeden Smiley pudełko, handel opcje<br> i kilka zmian w układzie.",
            ...
            options: {
                // bir:["Licznik Birremes", "Uwagę biremes miasto w mieście"],
                ...
                // cha: ["Herbata", "Zastąpił czat jako IRC."],
                ...
                // GrepotemasThemes
                Ths: ["Blue", "Zmienić kolorystykę, nie aktywują więcej niż jeden wątek na raz!"],
                Thy: ["yellow"],
                Thr: ["Red"],
                Thk: ["Pink"],
                Thf: ["purple"],
            ...
            buttons: {
                sav: "Zapisać", ins: "Wstawić", res: "Resetowanie"
           }
       },
          ////////////////////////////////////////////
        ...
        ro: {
            ...
            settings: {
                dsc: "DIO-Tools ofera, printre alte lucruri, unele ecrane, o cutie zâmbitoare, opțiuni de tranzacționare<br> și unele schimbări în structura.",
            ...
            options: {
                // bir:["Contor Birremes", "Contul de biremes oraș în oraș"],
                ...
                // cha: ["Ceai", "Înlocuit chat-ul ca de chat IRC."],
                ...
                // GrepotemasThemes
                Ths: ["Blue", "Modificarea temei de culoare, nu activează mai mult de un subiect la un moment dat!"],
                Thy: ["yellow"],
                Thr: ["Red"],
                Thk: ["Pink"],
                Thf: ["purple"],
            ...
            buttons: {
                sav: "A salva", ins: "Introduce", res: "Resetați"
           }
       },
          //////////////////////////////////////////
        ...
        es: {
            ...
            settings: {
                dsc: "DIO-Tools ofrece, entre otras cosas, algunas pantallas, una caja sonriente, las opciones de comercio<br> y algunos cambios en el diseño.",
            ...
            options: {
                // bir:["contador Birremes", "Birremes cuenta la ciudad de la ciudad"],
                ...
                // cha: ["Té", "Sustituido el chat como el chat IRC."],
                ...
                // GrepotemasThemes
                Ths: ["Blue", "Cambiar el tema de color, no active más de un tema a la vez!"],
                Thy: ["yellow"],
                Thr: ["Red"],
                Thk: ["Pink"],
                Thf: ["purple"],
            ...
            buttons: {
                sav: "Ahorrar", ins: "Insertar", res: "Reiniciar"
           }
       },
      ar: {},
          //////////////////////////////////////////////
        ...
        br: {
            ...
            options: {
                ...
                // GrepotemasThemes
                Ths: ["Blue", "Muda a cor do tema, Não ativar mais de 1 Tema de cada vez!"],
                Thy: ["yellow"],
                Thr: ["Red"],
                Thk: ["Pink"],
                Thf: ["purple"],
        ...
        cz: {
            ...
            settings: {
                dsc: "DIO-nářadí nabízí mimo jiné několik obrazovek, jeden smajlík box, obchodní možnosti<br> a některé změny v rozložení.",
            ...
            options: {
                // bir:["Counter Birremes", "Účet městské biremes ve městě"],
                ...
                // cha: ["Čaj", "Nahradil chatu jako IRC chat."],
                ...
                // GrepotemasThemes
                Ths: ["Blue", "Změnit barevný motiv, neaktivují více než jedno téma najednou!"],
                Thy: ["yellow"],
                Thr: ["Red"],
                Thk: ["Pink"],
                Thf: ["purple"],
            ...
            buttons: {
                sav: "Zachránit", ins: "Vložit", res: "Reset"
            }
        }
    };
    ...
    var options_def = {
        ...
        sml: false, // Smileys
        str: false, // Unit strength
        tra: false, // Transport capacity
        per: true, // Percentual Trade
        rec: true, // Recruiting Trade
        way: false, // Troop speed
        cnt: false, // Attack/support counter
        sim: false, // Simulator
        spl: false, // Spell box
        ...
        sen: false, // Sent units
        tov: false,// Town overview
        scr: true, // Mausrad,
        stt: true, //estactisticas
        err: false,// Error Reports
        Tti: false, // townTradeImprovement
        Ths: false, // Blue_Color_Theme
        Thy: false, // Yellow_Color_Theme
        Thr: false, // RedFlash_Color_Theme
        Thf: false, // purpleFlash_Color_Theme
        Thk: false, // PinkFlash_Color_Theme
        Thg: false, // halloween_Theme
        Thc: false, // Christmas
        OCC: false, // Number Ocean
        CVW: false, // city_view_cvw
        Ciw: false, // city_view_window
        Bjc: false, // BBTownPlayer
        SUA: false, // SelectUnitsAuto
        Mse: false, // MessageExport
        Isl: false, // islandFarmingVillages
        Ish: false, // farmingvillageshelper
        Cul: true, // cultureOverview
        Hio: false, // hidesOverview
        Hid: false, // hidesIndexIron
        ubv: false, // UnitsBeyondView
     ...
     var Messageversion = '';
	    ...
	    function getLatestVersion() {
	        $('<style id="dio_version">' +
	          '#version_info .version_icon { background: url(' + dio_sprite + ') -50px -50px no-repeat; width:25px; height:25px; float:left; } ' +
	          '#version_info .version_icon.red { filter:hue-rotate(-30deg); -webkit-filter: hue-rotate(-30deg); } ' + //-100deg
             ...
             '.version_icon.red::after { background: url(https://i.imgur.com/vJQ1iWe.png) no-repeat; width:25px; height:25px; float:left; } ' + //supement image change
             '.version_icon.red::after { position: absolute; content: ""; top: 0; left: 0; opacity: 0; -webkit-animation: fadeInOutIn 1.5s cubic-bezier(0,-0.65,1,-0.54) infinite; -ms-animation: fadeInOutIn 1.5s cubic-bezier(0,-0.65,1,-0.54) infinite; animation: fadeInOutIn 1.5s cubic-bezier(0,-0.65,1,-0.54) infinite; } ' + //suplement animation image
	         //'.version_icon.red:hover::after { -webkit-animation: none; -ms-animation: none; animation: none; opacity: 1; } ' + // suplement survol du mousse
	          '</style>').appendTo("head");

	        var v_info = $('#version_info');
	        if (version_text === '') {
	           if (version < latest_version) {
	              version_text = "<a href='https://greasyfork.org/fr/scripts/395523-dio-gatao-revision-image' target='_blank' style='color:crimson'><div class='version_icon red'></div><div class='version_text'>" + getText('settings', 'version_old') + "</div><div class='version_icon red'></div></a>" +
	         "<a class='version_text' href='https://greasyfork.org/scripts/395523-dio-gatao-revision-image/code/Dio-Gatao%20Revision%20image%20+.user.js' target='_blank'>--> " + getText('settings', 'version_update') + "</a>";
	                version_color = 'crimson';
	                Messageversion = HumanMessage.error("DIO-TOOLS " + getText('settings', 'version_old'));
	            } else if (version == latest_version) {
	                version_text = "<a href='https://greasyfork.org/fr/scripts/395523-dio-gatao-revision-image' target='_blank' style='color:darkgreen'><div class='version_icon green'></div><div class='version_text'>" + getText('settings', 'version_new') + "</div><div class='version_icon green'></div></a>";
	            } else {
	                version_text = "<a href='https://greasyfork.org/fr/scripts/395523-dio-gatao-revision-image' target='_blank' style='color:darkblue'><div class='version_icon blue'></div><div class='version_text'>" + getText('settings', 'version_dev') + "</div><div class='version_icon blue'></div></a>";
    ...
    function settings() {
        ...
        if (!$("#dio_tools").get(0)) {
            $(".settings-menu ul:last").append('<li id="dio_li"><img id="dio_icon" src="https://i.imgur.com/bW8lxNz.gif"></div> <a id="dio_tools" href="#"> DIO-Tools</a></li>');
        }
        ...
        $("#dio_tools").click(function () {
            ...
            if (!$('#dio_settings').get(0)) {
                ...
                $('<style id="dio_settings_style">' +
                    ...
                    '#dio_hall table td.laurel.bronze { background: url("https://i.imgur.com/vCFFUxt.png") no-repeat 25%; height:18px; width:18px; } ' +
                    '#dio_hall table td.laurel.silver { background: url("https://i.imgur.com/vCFFUxt.png") no-repeat 50%; height:18px; width:18px; } ' +
                    '#dio_hall table td.laurel.gold { background: url("https://i.imgur.com/vCFFUxt.png") no-repeat 75%; height:18px; width:18px; } ' +
                    '#dio_hall table td.laurel.blue { background: url("https://i.imgur.com/vCFFUxt.png") no-repeat 100%; height:18px; width:18px; } ' +
                    '</style>').appendTo('head');
                ...
                $('.settings-container').append(
                    ...
                    '<li><a class="submenu_link" href="#" id="dio_moi"><span class="left"><span class="right"><span class="middle">' + getText("settings", "cat_moi") + '</span></span></span></a></li>' +
                    '<li><a class="submenu_link" href="#" id="dio_nova"><span class="left"><span class="right"><span class="middle">' + getText("settings", "cat_nova") + '</span></span></span></a></li>' +
                    '</ul>' +
                    ...
                    '</tr><tr>' +
                    //echange retirado da lista nao foncionna
                    ...
                    // retirado da lista nao foncionna
                   ...
                   // '</tr><tr>' +
                    ...
                    // a minha pagina
                    '<table id="dio_moi_table" class="content_category"><tr>' +
                    //Avaliable lang
                    '</tr><tr>' +
                    ...
                    '</tr><tr>' +
                    //Violet e amarelo
                    '<td><img src="https://i.ibb.co/gzm52vC/51ges-Eou-MLL.png" alt="Grepotemas" style="transform: translate(20px, 30%)scale(1.50);"/></td>' +
                    '<td><div type="radio"  class="checkbox_new" id="Ths"><div class="cbx_icon"></div><div class="cbx_caption">' + getText("options", "Ths")[0] + '<span style="color:blue";>[̲̅$̲̅(̲̅ιο̲̅)̲̅$̲̅]</span>' + '</div></div>' +
                    '<p><div type="radio"  class="checkbox_new" id="Thr"><div class="cbx_icon"></div><div class="cbx_caption">' + getText("options", "Thr")[0] + '<span style="color:red";>[̲̅$̲̅(̲̅ιο̲̅)̲̅$̲̅]</span>' + '</p></div></div>' +
                    '<p><div type="radio"  class="checkbox_new" id="Thf"><div class="cbx_icon"></div><div class="cbx_caption">' + getText("options", "Thf")[0] + '<span style="color:purple";>[̲̅$̲̅(̲̅ιο̲̅)̲̅$̲̅]</span>' +  '</p></div></div>' +
                    '<p><div type="radio"  class="checkbox_new" id="Thy"><div class="cbx_icon"></div><div class="cbx_caption">' + getText("options", "Thy")[0] + '<span style="color:yellow";>[̲̅$̲̅(̲̅ιο̲̅)̲̅$̲̅]</span>' +  '</p></div></div>' +
                    '<p><div type="radio"  class="checkbox_new" id="Thk"><div class="cbx_icon"></div><div class="cbx_caption">' + getText("options", "Thk")[0] + '<span style="color:pink";>[̲̅$̲̅(̲̅ιο̲̅)̲̅$̲̅]</span>' +  '</p></div></div>' +
                    '<p><div type="radio"  class="checkbox_new" id="Thg"><div class="cbx_icon"></div><div class="cbx_caption">' + getText("options", "Thg")[0] + '<span>🎃</span>' +  '</p></div></div>' +
                    '<p><div type="radio"  class="checkbox_new" id="Thc"><div class="cbx_icon"></div><div class="cbx_caption">' + getText("options", "Thc")[0] + '<span>⛄</span>' +  '</p></div></div>' +
                    '<p style="color:#8E0303";><strong>' + getText("options", "Ths")[1] + '</strong></p><br></br></td>' +
                    '</tr><tr>' +
                    '</tr><tr>' +
                    // Link excel Formulario Cerco
                    '<td><img src="https://i.imgur.com/v0RLfUp.png" alt="" style="transform: scale(1.00);" /></td>' +
                  //'<td><div id="for" class="checkbox_new"><div class="cbx_icon"></div><div class="cbx_caption">' + getText("options", "for")[0] + '</div></div>' +
                    ...
                    '</tr></table>' +
                    // nova pagina
                    '<table id="dio_nova_table" class="content_category"><tr>' +
                    // texto principal da nova aba
                    '</tr><tr>' +
                    //'<td><img src="" alt="" /></td>' +
    ...
    function toggleActivation(opt) {
        ...
        switch (opt) {
            ...
            case "Tti":
                ...
                break;
           case "Thy":
                FEATURE = yellow_Color_Theme;
                break;
	       case "Ths":
                FEATURE = Blue_Color_Theme;
                break;
           case "Thg":
                FEATURE = halloween_Theme;
                break;
           case "Thc":
                FEATURE = Christmas_Theme;
                break;
           case "Thk":
                FEATURE = PinkFlash_Color_Theme;
                break;
           case "Thr":
                FEATURE = RedFlash_Color_Theme;
                break;
           case "Thf":
                FEATURE = PurpleFlash_Color_Theme;
                break;
           case "OCC":
...
// caixa dio-gatao configuraçoes
    function addSettingsButton() {
        var tooltip_str = dio_icon + "DIO-Gatao: " + (DM.getl10n("layout", "config_buttons").settings || "Settings");
        ...
        $('<style id="dio_settings_button" type="text/css">' +
            '#ui_box .btn_settings.dio_settings { top:85px; right:113px; z-index:10; } ' +
            '#ui_box .dio_settings .dio_icon { margin:3px 0px 0px 4px; width:24px; height:24px; background:url(https://i.imgur.com/f8WfWVa.gif) no-repeat; background-size:100% } ' +
    ...
    function setStyle() {
        ...
        $('<style id="dio_settings_style" type="text/css">' +
            '#dio_bg_medusa { background:url(https://i.imgur.com/WXiZqxa.png) no-repeat; height: 510px; width: 380px; right: -10px; top:6px; z-index: -1; position: absolute; opacity: 50%;} ' +
        ...
        // Velerios
        $('<style id="dio_velerios" type="text/css"> #ph_trader_image { background-image: url(https://i.imgur.com/ao0yOFU.jpg); } </style>').appendTo('head');
     ...
     *******************************************************************************************************************************/
     var dio = {
        createButton: function(t, e, n, i) {
            return "<a " + (i = void 0 === i ? "" : i) + ' class="dio-button button ' + (n = null == n || void 0 === n ? "" : n) + '" href="#" ' + (e = null == e ? "" : 'id="' + e + '"') + '><span class="left"><span class="right"><span class="middle">' + dio_icon + '' + t + '</span></span></span><span style="clear:both;"></span></a>'
        },
...
//alterar a cor du texto na caixa visão geral das unidades  / cor origem 126,223,126
    function createWindowType(name, title, width, height, minimizable, position) {
        $('<style id="dio_window">' +
            ...
            '.dio_title { margin:1px 6px 13px 23px; color:rgb(255,255,122); } ' +
            '</style>').appendTo('head');
        ...
        WndHandler.prototype.getDefaultWindowOptions = function () {
            return {
                ...
                title: "<img class='dio_title_img' src='https://i.imgur.com/f8WfWVa.gif' /><div class='dio_title'>" + title + "</div>"
            };
        };
    ...
    var Notification = {
        init: function () {
            ...
            // Window
            createWindowType("DIO_Notification", getText("settings", "Update"), 820, 550, true, ["center", "center", 100, 100]);

            // Style
            $('<style id="dio_notification" type="text/css">' +
              '#notification_area .diotools .icon { background: url(https://i.imgur.com/f8WfWVa.gif) 3px 1px no-repeat !important; transform: scale(0.80);} ' +
            ...
            if (notif <= 20) {
                ...
                var NotifText = '<div id="NotifText">' +
                    ...
                    //texto para menssagem notificacoes
                    '<p><span style="font-size:20px;">&nbsp;➫ New Simulator</span><br />' +
                    '&nbsp;- The simulator dedicated to the game has been totally innovated. (Check you out on the grepolis website -&gt; <a href="https://en.forum.grepolis.com/index.php?threads/simulator-update-announcement.63146/" target="_blank">More information</a>)<br />' +
                    '&nbsp;- The older versions were obsolete until 04/14/2021.<br />' +
                    '&nbsp;- To be able to see or use the new simulator you will first have to disable the Dio-Tools simulator in configurations, layout..<br />' +
                    ...
                    '<a id="link_contact" href=' + getText("link", "forum") + ' target="_blank">Grepotemas</a></span>' +
                ...
                $('.diotools .icon').click(function () {
                    var BBwnd = GPWindowMgr.Create(GPWindowMgr.TYPE_DIO_Notification) || GPWindowMgr.getOpenFirst(GPWindowMgr.TYPE_DIO_Notification).close();
        ...
        create: function (nid, feature) {
            ...
            Notification.notify($('#notification_area>.notification').length + 1, uw.NotificationType.DIO_TOOLS,
                                "<span style='color:rgb(8, 207, 0)'><b><u>" + getText("settings", "Feature") + " 07/05/2021 !</u></b></span>" + feature + "<span class='small notification_date'>DIO-Tools: v" + version + "</span>");
        }
    };
    ...
    var Statistics = {
        ...
        addButton: function () {
            ...
            $('<style id="dio_statistic_style">' +
                ...
                '#dio_statistic_button .ico_statistics { margin:7px 0px 0px 8px; width:17px; height:17px; background:url(https://i.imgur.com/wsmJMqz.png) no-repeat 0px 0px; background-size:100%; } ' +
        ...
        Map: {
            ...
            activate: function () {
                try {
                    ...
                    // Style for own towns (town icons) alterar a cor dos icones cidades (255, 187, 0)
                    ...
                    for (var e in autoTownTypes) {
                        if (autoTownTypes.hasOwnProperty(e)) {
                            style_str += "#mini_t" + e + ", #town_flag_"+ e + " .flagpole {"+
                                "background: rgb(256, 256, 0) url(" + dio_sprite + ") " + (TownIcons.types[(manuTownTypes[e] || autoTownTypes[e])] * -25) + "px -27px repeat !important; } ";
                        }
                    }
    ...
    var TownPopup = {
        activate : function(){
            ...
            $('<style id="dio_town_popup_style" type="text/css">' +
                ...
                '#dio_town_popup { position:absolute; z-index:6002;max-width: 173px;} ' +
                ...
                //'#dio_town_popup .god_mini.null { background-image: url(https://gppt.innogamescdn.com/images/game/autogenerated/layout/layout_596941d.png); background-repeat: no-repeat; transform: scale(0.7); background-position: center; } ' +
                '#dio_town_popup .god_mini.null { background: url(https://gppt.innogamescdn.com/images/game/autogenerated/layout/layout_596941d.png) no-repeat -488px -212px; width: 80px; height: 88px; z-index: 8; position: absolute; top: 136px; right: 7px; cursor: pointer; transform: scale(0.35);} ' +
                //'#dio_town_popup .god_mini { height: 25px; width: 32px; background-size: 75%; background-repeat: no-repeat; background-position: 0px -122px; margin-right: -8px; } ' +
        ...
        add : function(that){
            ...
            if (typeof(uw.ITowns.getTown(townID)) !== "undefined") {
                ...
                // Title (town name)
                popup += "<h4><span style='white-space: nowrap;margin-right:35px;'>" + uw.ITowns.getTown(townID).name + "</span><img class='dio_branding' src='https://i.imgur.com/f8WfWVa.gif'></h4>";
                ...
                // - hero Content
                    var HeroArray = ITowns.getHeroDIO()[townID];
                    if (HeroArray) {
    ...
    var AvailableUnits = {
        activate: function () {
            ...
            if (Game.gods_active.aphrodite || Game.gods_active.ares) {
                createWindowType("DIO_UNITS", (LANG.hasOwnProperty(LID) ? getText("options", "ava")[0] : default_title), 417, 315, true, [240, 70]);
            }else {
                createWindowType("DIO_UNITS", (LANG.hasOwnProperty(LID) ? getText("options", "ava")[0] : default_title), 365, 315, true, [240, 70]);
            }
        ...
        addButton: function () {
            ...
            // Tooltip
            $('#btn_available_units').tooltip(LANG.hasOwnProperty(LID) ? dio_icon + getText("labels", "uni") : default_title);
        ...
        openWindow: function () {
            ...
            var land_units_str = "", content =
                ...
                //tropas em apoio
                //'<td width="25%"><div class="option js-option" name="support"><div class="pointer"></div>' + DM.getl10n("context_menu", "titles").support + '</div></td>'+
                '</tr></table>'+
                '<hr>'+
            ...
            $('#dio_help_available_units').tooltip('Wiki (' + getText("options", "ava")[0] + ')');
            for (var unit in unitArray) {
                if (unitArray.hasOwnProperty(unit)) {
    ...
    var UnitComparison = {
        activate: function () {
            ...
            // Create Window Type
            createWindowType("DIO_COMPARISON", getText("labels", "dsc"), 520, 405, true, ["center", "center", 100, 100]);
            ...
            $('<style id="dio_comparison_style"> ' +
                ...
                '#dio_comparison table { width:520px; } ' +
                ...
                '#dio_comparison .box_content { background:url(https://i.imgur.com/ZokrwGJ.png) 94% 94% no-repeat; background-size:140px; } ' +

                '#dio_comparison .compare_type_icon { height:25px; width:25px; background:url(https://i.imgur.com/Eh2qca2.png); background-size:100%; } ' +
                '#dio_comparison .compare_type_icon.booty { background:url(https://i.imgur.com/0b8lJGF.png); background-size:100%; } ' +
                '#dio_comparison .compare_type_icon.time { background:url(https://i.imgur.com/4pXZiwH.png); background-size:100%; } ' +
                '#dio_comparison .compare_type_icon.favor { background:url(https://i.imgur.com/FFl3t2I.png); background-size:100%; } ' +
        ...
        addButton: function () {
            ...
            // Tooltip
            $('#dio_comparison_button').tooltip(dio_icon + getText("labels", "dsc"));
        },
        openWindow: function () {
            var content =
                // Title tabs
            ...
            for (var e in uw.GameData.units) {
                if (uw.GameData.units.hasOwnProperty(e)) {
                    ...
                    if (type === (uw.GameData.units[e].attack_type || "sea") && (e !== "militia")) {
                        ...
                        UnitComparison.t++;
                        $('#dio_help_UnitComparison').tooltip('Wiki (' + getText("options", "com")[0] + ')');
                    }
                }
            }
    ...
    var WorldWonderCalculator = {
        activate: function () {
            ...
            $('<style id="dio_wonder_calculator"> ' +
                //'.button_new { margin-top: 90px; margin-left: 105px; } ' +
        ...
        deactivate: function () {
            $('#dio_wonder.button_new_calculator').remove();
    ...
    var DurationCalculator = {
        activate: function () {
            var speedBoosterSprite = "https://i.imgur.com/hrUN5o6.png"; //https://diotools.de/images/game/speed_booster.png
    ...
    var RecruitingTrade = {
        activate: function () {
            $('<style id="dio_style_recruiting_trade" type="text/css">' +
              ...
              '#dio_recruiting_trade .drop_rec_unit { position:absolute; display:block; width:50px; overflow:visible; z-index: 200px; } ' +
        ...
        add: function (wndID) {
            ...
            $(wndID + '.drop_rec_unit').tooltip(dio_icon + getText("labels", "rat"));
            $(wndID + '.drop_rec_perc').tooltip(dio_icon + getText("labels", "shr"));
            ...
            $('#diofestivals').tooltip(getText("Quack", "cityfestivals"));
    ...
    function addPercentTrade(wndID, ww) {
        ...
        $(wndID + '.btn_trade').tooltip(dio_icon + getText("labels", "per"));

        setPercentTrade(wndID, ww);

        // Style
        $(wndID + '.btn').css({width: '20px', overflow: 'visible', position: 'absolute', display: 'block', marginLeft: '20px'});
        ...
        if (ww) {
            $(wndID + '.btn_trade').css({left: '638px', top: '154px'});
        } else {
            $(wndID + '.btn_trade').css({left: '336px', top: '129px'});
        }
        ...
        Menu: {
            activate: function () {
                $('<div id="strength" class="cont def"><hr>' +
                    ...
                    //'</div></div>').appendTo('.units_land .content'); //avant nouveau boutton force des troupes

                  //debut boutton fenetre force des troupes
                '</div></div>' +
                '<div id= "dio_tr_btn" class="">' + getText("options", "str")[0] + '</div>').appendTo('.units_land .content');

                $(".units_land .nav .border_top").click(function () {BarracksWindowFactory.openBarracksWindow();});
                ...
                //finale boutton fenetre force des troupes
    ...
    var TransportCapacity = {
        activate: function () {
            ...
            $('#dio_tr_recruit').tooltip(dio_icon + getText("transport_calc", "recruits"));
            $('#dio_transporter').tooltip(dio_icon + DM.getl10n("barracks").tooltips.ship_transport.title);
        },
        deactivate: function () {
            $('#transporter').remove();
        ...
        activate: function () {
            $('<style id="dio_simulator_style" type="text/css">' +
                ...
                '#place_sim_ground_units { position:absolute; bottom: 35px;} ' +
                   ...
                   // Estimativa pontos de combate JoeMan
                '#place_sim_battlepoints { position: absolute; top: 297px; right: 10px; } ' +
                //'#place_sim_battlepoints tbody tr:last-child { height:auto !important; }' +
    ...
    function addForm(e) {
        ...
        $('<a title="formulario Pedido de apoio" href="#" class="dio_bbcode_option def_form" name="def_form"></a>').appendTo(bbcodeBarId + ' .bb_button_wrapper');
        ...
        var imgArray = {
			...
			Def1: 'https://i.imgur.com/9F5OQ3D.png',//https://i.imgur.com/EGJ82Ka.png
            ...
            R121: 'https://i.imgur.com/UnsgrPN.jpg',//https://i.imgur.com/IKVoJpB.png eliminer
            ...
            militia: 'https://wiki.en.grepolis.com/images/9/9b/Militia_40x40.png', //http://wiki.en.grepolis.com/images/9/9b/Militia_40x40.png
            sword: 'https://wiki.en.grepolis.com/images/9/9c/Sword_40x40.png', //http://wiki.en.grepolis.com/images/9/9c/Sword_40x40.png
            slinger: 'https://wiki.en.grepolis.com/images/d/dc/Slinger_40x40.png', //http://wiki.en.grepolis.com/images/d/dc/Slinger_40x40.png
            archer: 'https://wiki.en.grepolis.com/images/1/1a/Archer_40x40.png',  //http://wiki.en.grepolis.com/images/1/1a/Archer_40x40.png
            hoplite: 'https://wiki.en.grepolis.com/images/b/bd/Hoplite_40x40.png', //http://wiki.en.grepolis.com/images/b/bd/Hoplite_40x40.png
            rider: 'https://wiki.en.grepolis.com/images/e/e9/Rider_40x40.png', //http://wiki.en.grepolis.com/images/e/e9/Rider_40x40.png
            chariot: 'https://wiki.en.grepolis.com/images/b/b8/Chariot_40x40.png', //http://wiki.en.grepolis.com/images/b/b8/Chariot_40x40.png
            ...
            move_icon: 'https://gpall.innogamescdn.com/images/game/unit_overview/attack.png', //https://gpall.innogamescdn.com/images/game/unit_overview/',//?
        ...
        $('<div class="bb_def_chooser">' +
           ...
           // '<div id="f_mov" class="checkbox_new "><div class="cbx_icon"></div><div class="cbx_caption">' + getText("labels", "mov") + '</div></div><br><br>' +
            ...
            '<div><a class="button" id="dio_insert" href="#"><span class="left"><span class="right"><span class="middle"><small>' + dio_icon + '' + getText("buttons", "ins") + '</small></span></span></span><span></span></a></div>' +
       ...
       //bireme1 = uw.Game.nBonus
        ...
        $(bbcodeBarId + ' #dio_insert').click(function () {
            ...
            var str = '[center]' + '[font=serif]' + '\n\n[color=#07701B][size=18][u][b]' + getText("labels", "ttl") + ' [/b][/u][/size][/color]\n' + '[/font]' + '[/center]' +
                ...
                //($('#f_R212').hasClass("checked") ? '[img]' + imgArray.R121 + '[/img]': ' ') + '[/*]\n' +
                ...
                '[center]' + (uw.ITowns.getTown(uw.Game.townId).researches().attributes.phalanx ? '[b][color=#004d00]✔️[/color][/b]' : '[b][color=#992600]❌[/color][/b]') + '[/center][||]' +
                '[center]' + (uw.ITowns.getTown(uw.Game.townId).researches().attributes.ram ? '[b][color=#004d00]✔️[/color][/b]' : '[b][color=#992600]❌[/color][/b]') + '[/center][||]' +
                '[center]' + (uw.ITowns.getTown(uw.Game.townId).researches().attributes.divine_selection ? '[b][color=#004d00]✔️[/color][/b]' : '[b][color=#992600]❌[/color][/b]') + '[/center][||]' +
                ($('#f_prm').hasClass("checked") ? '[center]' + ((uw.Game.premium_features.commander >= uw.Timestamp.now()) ? '[b][color=#004d00]✔️[/color][/b]' : '[b][color=#992600]❌[/color][/b]') + '[/center][||]' : ' ') +
                ($('#f_prm').hasClass("checked") ? '[center]' + ((uw.Game.premium_features.captain >= uw.Timestamp.now()) ? '[b][color=#004d00]✔️[/color][/b]' : '[b][color=#992600]❌[/color][/b]') + '[/center][||]' : ' ') +
                ($('#f_prm').hasClass("checked") ? '[center]' + ((uw.Game.premium_features.priest >= uw.Timestamp.now()) ? '[b][color=#004d00]✔️[/color][/b]' : '[b][color=#992600]❌[/color][/b]') + '[/center][||]' : ' ') +
                ...
                '[center]' + $('.favor_amount').get(0).innerHTML + '[/center][||]' + //mostrar a quantidade de favores
                //'[center]' + '[b][color=#004d00]✔️[/color][/b][/center][||]' + //nao mostrar a quantidade de favores
...
//($('#f_R22').hasClass("checked") ? '[color=#08781C][size=9][i][b]' + getText("labels", "R2") + '[/b][/i][/size][/color]' + '[color=#28045A][size=8][i][b]' + ( "  🕐🕑:🕒🕓:🕔🕕" ) + '[/b][/i][/size][/color]\n' : ' ')+
                '[size=7][url=https://greasyfork.org/fr/scripts/395523-dio-tools-gatinho/]DIO-TOOLS-Gatinho[/url] - (v' +'\u00a0'+ version + ')' + '[/size]\n' ;
                //($('#f_ASE').hasClass("checked") ? '[color=#28045A][size=9][i][b]' + getText("labels", "ASE") + '[/b][/i][/size][/color]' + '[color=#08781C][size=8][i][b]' + getText("labels", "DTRI") + '[/b][/i][/size][/color]' + '[color=#28045A][size=8][i][b]' + trireme1 + '[color=#08781C][size=8][i][b]' + getText("labels", "DBIR") + '[/b][/i][/size][/color]'  + '[color=#28045A][size=8][i][b]' + bireme1 + '[/b][/i][/size][/color]' : ' ');
            ...
            /*if ($('#f_mov').hasClass("checked")) {
                move_table += '\n[color=#28045A][size=12][i][b]' + getText("labels", "mov") + '[/b][/i][/size][/color]\n[table]';
                ...
                move_table += (i % 1) ? "[/**]" : "";
                move_table += "[*][|][color=#300000][size=6][i] (" + getText("labels", "dev") + ": ±1s)[/i][/size][/color][/*][/table]\n";
            }*/
    ...
    var SmileyBox = {
        ...
        activate: function () {
            ...
            if (SmileyBox.isForum) {
                smileyArray.grepolis.push("pVAK8KH"); // Pacman
                smileyArray.grepolis.push("2w3xZnz"); // Bugpolis
                smileyArray.grepolis.push("fZlUp0N"); // Inno
            }
        ...
        loadSmileys: function () {
            ...
            if (LID !== "de") {
                smileyArray.other[17] = "VaC8Je2";//dagegen2
                smileyArray.other[19] = "F9PlIJc";//bvenLlJ
            }
     ...
     * ----------------------------------------------------------------------------------------------------------------------------
     * @deprecated POUR LES MONDE SIEGE
     * *****************************************************************************************************************************/
    ...
    var FavorPopup = {
        ...
        activate: function () {
            ...
            $('<div id="dio_FavorPopup" style="width: 80px; height: 35px; position: absolute; left: 35px; top: 2px;"></div>').appendTo('.gods_favor_amount');
            $('<div id="dio_FuryPopup" class="fury_amount" style="width: 60px; height: 31px; position: absolute; right: 100px; top: 2px;"></div>').appendTo('.gods_favor_amount');
        ...
        setFavorPopup: function () {
            var pic_row = "", fav_row = "", prod_row = "", tooltip_str, textColor;
                ...
                if (FavorPopup.godArray.hasOwnProperty(g)) {
                    if (uw.ITowns.player_gods.attributes.temples_for_gods[g]) {
                        ...
                        fav_row += '<td class="bold" style="color:blue">' + uw.ITowns.player_gods.attributes[g + "_favor"] + '</td>';
                         textColor = ((uw.ITowns.player_gods.attributes[g + "_favor"]) == ITowns.player_gods.attributes.max_favor) ? textColor = "color:red;" : textColor = "color:darkgreen";
    ...
    /*******************************************************************************************************************************
     * GUI Optimization Revision 13/09/2020 JoeMan
     * ----------------------------------------------------------------------------------------------------------------------------
    ...
    var Spellbox = {
        ...
        activate: function () {
            ...
            $('<style id="dio_spellbox_style" type="text/css">' +
                ...
                '.gods_spells_menu.ui-draggable {  margin-left: 228%; } ' +
                //'.gods_spells_menu .header .btn_close {  left: -150px; } ' +
                ...
                // conflit aves la calculatrice d heures
    ...
    var Chat = {
        ...
        activate : function(){
            ...
            $('<style id="dio_chat_style">'+
                ...
                '#dio_chat .icon { position:absolute; right:10px; top:10px; opacity:0.15; width: 31px; height:31px; filter: sepia(0.5); background: url(https://i.imgur.com/cILbyDs.png) -50px -76px no-repeat; }'+
    ...
    var ActivityBoxes = {
        activate: function () {
            ...
            $('<style id="Freese_movements_style">' +
              ...
              //'.toolbar_activities .dropdown_box { visibility: visible; display: block !important; }' +
    ...
    *******************************************************************************************************************************/
    ...
    var hidesOverview = {
        activate: function () {
            $('<style id="dio_hidesOverview_style"> ' +
              ...
              // style
              '#dio_hides_sort_control { bottom: -8px; left: -9px; padding: 0 2px; right: -9px; top: -9px; z-index: 3000;} ' +
              '#dio_button_table_resize { background-image: url("https://i.imgur.com/cNyFYNz.png"); background-repeat: no-repeat; display: block !important; float: left; width: 22px; height: 23px; margin-right: 5px; margin-top: 2px; cursor: pointer;} ' +
    ...
    var cultureOverview = {
        activate: function (e) {
            try {
                ...
                $(".dio_cultureBTN_cityfestival").tooltip(dio_icon + getText("Quack", "cityfestivals"));
                $(".dio_cultureBTN_olympicgames").tooltip(dio_icon + getText("Quack", "olympicgames"));
                $(".dio_cultureBTN_triumph").tooltip(dio_icon + getText("Quack", "triumph"));
                $(".dio_cultureBTN_theather").tooltip(dio_icon + getText("Quack", "theater"));
            } catch (error) {
        ...
        islandHeader : function () {
            $('#fto_town_list li').each(function( index ) {
                if (this.classList.length == 2) {
                    ...
                    $(this).append(
                        '<div class="dio_colordivider" style="background: linear-gradient(to right,rgba(74, 195, 6, 0.85),rgba(116, 241, 98, 0.29)); display: block; height: 24px; margin: -4px -2px;"></div>' +
    ...
    /*var islandFarmingVillages = {
        activate: function () {
            ...
            $('<style id="dio_message_recipients_style">' +
              '#dio_message_island { float: right; right: 3px; height: 23px; width: 22px; background: url("https://i.imgur.com/QEDKbru.png") no-repeat; 0px 0px; }' +
              '</style>').appendTo('head');
            ...
            $("#dio_message_island").click(function () {
                ...
                if (!$("#island_info_towns_left_sorted_by_name li span.player_name a.gp_player_link").is(":visible")) {
                    $("#island_info_towns_left_sorted_by_name li span.player_name").each(function () {
                        if ($(this).text() != pName && $(this).text() != DM.getl10n("alliance").profile.tooltip_msg_no_recipients && $(this).text() != getText("messages", "no_cities") + "." && spielernamen.indexOf($(this).text()) < 0) {
            ...
            // Tooltip
            $('#dio_message_island').tooltip(dio_icon + DM.getl10n("layout").main_menu.items.messages +" "+ DM.getl10n("bbcodes").island.name);
        },
        deactivate: function () {
    ...
    var MessageExport = {
        activate: function() {
            try {
                ...
                createWindowType("DIO_BBCODEE", getText("messages", "bbmessages"), 700, 350, true, ["center", "center", 100, 100]);
                var wnd = GPWindowMgr.getOpenFirst(GPWindowMgr.TYPE_MESSAGE);
                var wndid = wnd.getID();
                if ($("#dio_messageExport").is(":visible"))
                    return;
                $('#qt_messageExport').remove();
                $("DIV#gpwnd_" + wndid + " DIV#message_message_list .game_header:first").append('<div id="dio_messageExport" style="float:right; margin-right:-5px; margin-top:-21px; cursor:pointer;">' + dio.createButton(getText("messages", "bbmessages")) + '</div><div id="dio_messageExportTMP" style="display:none"></div>');
                $("#dio_messageExport").tooltip(getText("messages", "export"));
                $("#dio_messageExport").click(function () {
                    ...
                    $(".message_post_container .message_post").each(function (index, element) {
                        var dio_messageExportTMP = $("#dio_messageExportTMP");
                        dio_messageExportTMP.empty();

                        var i, e, n = dio_messageExportTMP.html();
                        ...
                        dio_messageExportTMP.find(".bbcode_awards").replaceWith("[img]https://i.imgur.com/xedCCJ0.gif[/img]"); //replace awards
                        ...
                        bb_content += '[img]https://i.imgur.com/UqsrNy2.png[/img]\n';
                        var postHTML = $("#dio_messageExportTMP .message_post_content").html().trim();
                    ...
                    bb_content += "[url=https://greasyfork.org/fr/scripts/395523-dio-gatao-revision-image/]DIO-TOOLS[/url] - v."+ version;
                    bb_content += "[/quote]";
                    ...
                    var expRahmen_c = "</textarea></div><center>" + dio.createButton(getText("messages", "copy"), "dio-copy-message-quote", null, 'data-clipboard-target="#expTextarea"') + "</center>";
                    var expRahmen_d = "<div style='overflow-x: hidden; padding-left: 5px; position: relative;'></div></div></div>";
                    var expRahmen_e = '<div id="dio_help_MessageExport" style="top: -37px;position: absolute; right: 33px;"><a class="ui-dialog-titlebar-help ui-corner-all" href=' + getText("link", "MessageExport") + ' target="_blank"></a></div>';
                    //"<center>" + dio.createButton(getText("labels", "dsc"), "dio-copy-message-quote", null, 'data-clipboard-target="#expTextarea"') + "</center>";
                    ...
                    $('#dio_help_MessageExport').tooltip('Wiki (' + getText("options", "Mse")[0] + ')');
        ...
        addCopyListener: function() {
            new ClipboardJS("#dio-copy-message-quote").on("success", function() {
                setTimeout(function() {
                    HumanMessage.success(getText("messages", "copybb"))
                }, 50)
                GPWindowMgr.getOpenFirst(GPWindowMgr.TYPE_DIO_BBCODEE).close();
            })
        },
            ...
            try {
                ...
                for (var e in wnds) {
                    if (wnds.hasOwnProperty(e)) {
                        ...
                        //$('DIV#gpwnd_'+wndid+' A.select_all_units').after(' | <a class="dio_balanced" style="position:relative; top:4px" href="#">'+getText("labels", "no_overload")+'</a> | <a class="dio_delete" style="position:relative; top:4px" href="#">'+DM.getl10n("market").delete_all_market_offers+'</a>');
                          $('DIV#gpwnd_'+wndid+' A.select_all_units').after(' | <a class="dio_balanced" title = "No overload" style="position: relative;background: url(https://gppt.innogamescdn.com/images/game/layout/alpha_sprite_2.69.png) no-repeat -321px -0px;display: inline-block;padding: 20px 0px 0px 32px;margin-bottom: -10px;" href="#"></a> | <a class="dio_delete" title = "Reset" style="background: url(https://gppt.innogamescdn.com/images/game/layout/alpha_sprite_2.69.png) no-repeat -377px -25px;display: inline-block;position: relative;margin-bottom: -12px;padding: 23px 0px 0px 24px;" href="#"></a>');
    ...
    var BBTownPlayer = {
        activate: function () {
            ...
            for (var e in wnds) {
                if (wnds.hasOwnProperty(e)) {
                    ...
                    $('<style id="dio_BBtowninfo_style"> ' +
                      ...
                      // clipboard
                      '#dio_'+wndid+'clipboard-player { background: rgba(0, 0, 0, 0) url("https://gppt.innogamescdn.com/images/game/autogenerated/layout/layout_596941d.png") no-repeat scroll -482px -647px; position:absolute; height: 18px; width: 18px; z-index: 555; top:4px ;left: 229px; } ' +
                      '#dio_'+wndid+'clipboard-alliance { background: rgba(0, 0, 0, 0) url("https://gppt.innogamescdn.com/images/game/autogenerated/layout/layout_596941d.png") no-repeat scroll -482px -647px; position:absolute; height: 18px; width: 18px; z-index: 555; top:4px ;left: 229px; } ' +
                      '#dio_'+wndid+'clipboard-player:hover { filter: drop-shadow(0 0mm 2mm rgb(0, 210, 53)); } ' +
                      '#dio_'+wndid+'clipboard-alliance:hover { filter: drop-shadow(0 0mm 2mm rgb(0, 210, 53)); } ' +
                      // Style
                    ...
                    if (!$('#dio_'+wndid+'BBplayer').get(0)){
                        ...
                        // BBCode player
                        if ($("div#gpwnd_"+wndid+" div#info_tab_content div#towninfo_towninfo div.game_border ul.game_list li.even div.list_item_left a.gp_player_link").is(':visible')){
                            $('<a id="dio_'+wndid+'BBplayer"></a><input id="input_'+wndid+'BBplayer" type="text" onfocus="this.select();" onclick="this.select();"></div>').appendTo('div#gpwnd_'+wndid+' div#info_tab_content div#towninfo_towninfo div.game_border ul.game_list li.even div.list_item_left');
                        ...
                        // BBCode alliance
                        $('<a id="dio_'+wndid+'BBalliance"></a><input id="input_'+wndid+'BBalliance" type="text" onfocus="this.select();" onclick="this.select();"></div>').appendTo('div#gpwnd_'+wndid+' div#info_tab_content div#towninfo_towninfo div.game_border ul.game_list li.odd.clearfix');
                        $("#dio_"+wndid+"BBalliance").click(function () {

                            if ($('#dio_'+wndid+'clipboard-alliance').is(':visible')){
                                $('#dio_'+wndid+'clipboard-alliance').remove();
                            }else { $('<a id="dio_'+wndid+'clipboard-alliance" data-clipboard-text="[ally]' + $("div#gpwnd_"+wndid+" div#info_tab_content div#towninfo_towninfo div.game_border ul.game_list li.odd.clearfix a").text().trim() + '[/ally]"></a>').appendTo('div#gpwnd_'+wndid+' div#info_tab_content div#towninfo_towninfo div.game_border ul.game_list li.odd.clearfix').tooltip(getText("messages", "copy"));}
                        ...
                        // Clipboard success
                        new ClipboardJS("#dio_"+wndid+"clipboard-player").on("success", function() {
                            setTimeout(function() {
                                HumanMessage.success(getText("messages", "copybb"))
                            }, 50)
                        })
                        new ClipboardJS("#dio_"+wndid+"clipboard-alliance").on("success", function() {
                            setTimeout(function() {
                                HumanMessage.success(getText("messages", "copybb"))
                            }, 50)
                        })
            ...
            // Tooltip
            $('#dio_'+wndid+'BBplayer').tooltip(dio_icon + 'BBCode '+ DM.getl10n("bbcodes").player.name);
            $('#dio_'+wndid+'BBalliance').tooltip(dio_icon + 'BBCode '+ DM.getl10n("bbcodes").ally.name);
        },
        deactivate: function () {
            $('#dio_BBTownPlayer_style').remove();
        ...
        activate: function () {
            try {
                ...
                $('<style id="dio_plusmenustyle" type="text/css">' +
                  ...
                  '.dio_plusdraghandle {width:100%;height:11px;position:absolute;background:url(https://i.ibb.co/74WtWbV/grille.png)}' +
                  '.dio_plusback {right:-18px;margin-top:-1px;width:16px;height:12px;position:absolute;background:url(https://i.ibb.co/8mCL0TR/plusback.png)}' +
    ...
    var Townbb = {
        activate: function () {
            ...
            $('<style id="dio_townbb_style"> ' +
              ...
              // Button
              '#dio_townbb { background: url("https://i.imgur.com/BoAdRfl.png") -23px 0px transparent; position:absolute; height: 22px; width: 21px; top:26px; left:184px; z-index:200; } ' +
              '#dio_townbb:hover { background: url("https://i.imgur.com/BoAdRfl.png") -23px -23px transparent; position:absolute; height: 22px; width: 21px; top:26px; left:184px; z-index:5; } ' +
              '#dio_townbb_logo { background: url(""); position: absolute; height: 30px; width: 30px; left:180px; top:27px; } ' +
              '#dio_townbb-clipboard:hover { filter: drop-shadow(0 0mm 2mm rgb(0, 210, 53)); } ' +
              // Style
              ...
              // clipboard
              '#dio_townbb-clipboard { background: rgba(0, 0, 0, 0) url("https://gppt.innogamescdn.com/images/game/autogenerated/layout/layout_596941d.png") no-repeat scroll -482px -647px; position: absolute; height: 18px; width: 18px; z-index: 555; top: 29px; left: 167px; } ' +
              '</style>').appendTo("head");
        ...
        addButton: function () {
            ...
            $("#dio_townbb").click(function () {
                ...
                }else { $('<a id="dio_townbb-clipboard" data-clipboard-text="[town]' + Game.townId + '[/town]"></a>').appendTo('.town_name_area').tooltip(getText("messages", "copy"));}
            ...
            // clipboard
            new ClipboardJS("#dio_townbb-clipboard").on("success", function() {
                setTimeout(function() {
                    HumanMessage.success(getText("messages", "copybb"))
                }, 50)
            })
            ...
            // Tooltip
            $('#dio_townbb').tooltip(dio_icon + getText("labels", "BBV"));
            $('#dio_townbb-clipboard').tooltip(dio_icon + 'BBCode '+ DM.getl10n("market").city);
        },
    };
     /*******************************************************************************************************************************
     * city_view
    ...
    var city_view_cvw = {
        activate: function () {
            $('<style id="dio_city_longe_style"> ' +
              //diminue lespace pour les icone lateraux
            ...
            function dio_island_overview() {
                ...
                $('#ui_box .nui_main_menu .middle .content ul li[data-option-id=dio_cityview] .name').text(getText("grepo_mainmenu", "island_view"));
            }
            function dio_city_overview() {
                ...
                $('#ui_box .nui_main_menu .middle .content ul li[data-option-id=dio_cityview] .name').text(getText("grepo_mainmenu", "city_view"));
            }

            $.Observer(GameEvents.ui.bull_eye.radiobutton.city_overview.click).subscribe('dio_city_overview', function (e, data) {
                dio_island_overview();
            });

            $.Observer(GameEvents.ui.bull_eye.radiobutton.island_view.click).subscribe('dio_island_view', function (e, data) {
                dio_city_overview();
            });

            $.Observer(GameEvents.ui.bull_eye.radiobutton.strategic_map.click).subscribe('dio_strategic_map', function (e, data) {
                dio_city_overview();
            });
        ...
        activate: function () {
			...
			WndHandlerDIOtownoverview.prototype.getDefaultWindowOptions = function () {
				return {
					...
					width : 800,
					minimizable : true,
					title : "<img class='dio_title_img' src='https://i.imgur.com/f8WfWVa.gif' /><div class='dio_title'>" + getText("grepo_mainmenu", "city_view") + "</div>"
				};
			};
            ...
            GPWindowMgr.addWndType("DIO_TOWNOVERVIEW", "dio_townoverview", WndHandlerDIOtownoverview, 1);
            //createWindowType("QT_TOWNOVERVIEW", getText("labels", "tow"), 700, 700, true, ["center", "center", 100, 100]);
            $.Observer(GameEvents.ui.bull_eye.radiobutton.city_overview.click).subscribe('dio_city_overview_window', function Felix (e, data) {
                if (DATA.options.Ciw) {
                    var city_wnd = GPWindowMgr.getOpenFirst(Layout.wnd.TYPE_DIO_TOWNOVERVIEW);
                    if (city_wnd) {
                        city_wnd.setTitle("<img class='dio_title_img' src='https://i.imgur.com/f8WfWVa.gif' /><div class='dio_title'>" + getText("grepo_mainmenu", "city_view") + " - " + Game.townName + "</div>");
                        return;
                    }
                    var html = '<div id="dio_townoverview"></div>';
                    var wnd = GPWindowMgr.Create(GPWindowMgr.TYPE_DIO_TOWNOVERVIEW) || GPWindowMgr.getOpenFirst(GPWindowMgr.TYPE_DIO_TOWNOVERVIEW);
                    wnd.setContent(html);
                    wnd.setTitle("<img class='dio_title_img' src='https://i.imgur.com/f8WfWVa.gif' /><div class='dio_title'>" + getText("grepo_mainmenu", "city_view") + " - " + Game.townName + "</div>");
            ...
            $("#ui_box .bull_eye_buttons .rb_map").on("rb:change:value", function (e, value, old_value) {
                if (value === 'island_view' || value === 'strategic_map') {
                    var wnd = GPWindowMgr.getOpenFirst(Layout.wnd.TYPE_DIO_TOWNOVERVIEW);
					if (!wnd)
						return;
					wnd.close();
				}
    ...
    var townTradeImprovement = {
        ...
        add: function () {
            var wnd = GPWindowMgr.getFocusedWindow() || false;
            var dio_wnd = wnd.getJQElement().find(".gpwindow_content");
            var dio_wndid = wnd.getID();

			if (dio_wnd.find(".dio_needed").length > 0 || dio_wnd.find(".town-capacity-indicator").length == 0)
				return;
            $('.q_send_cult_reverse').remove();
			...
			dio_wnd.find(".tripple-progress-progressbar").each(function () {
				var res_type = this.id.split("_")[2];
				var res = getRes(res_type, dio_wndid);
				$(this).find(".amounts").append('<span class="dio_needed_' + res_type + '_' + dio_wndid + '"> &#9658; ' + res.needed + '</span>');
			});

			dio_wnd.find("#trade_tab").append(
                '<div id="dio_Improvement_trade">' +
				'<a id="dio_wood_'+dio_wndid+'_max" class="dio_trade dio_max" style="top:200px"></a>' +
				'<a id="dio_stone_'+dio_wndid+'_max" class="dio_trade dio_max" style="top:234px"></a>' +
				'<a id="dio_iron_'+dio_wndid+'_max" class="dio_trade dio_max" style="top:268px"></a>' +
				'<a id="dio_wood_'+dio_wndid+'_cult" class="dio_trade dio_send_cult" style="top:200px"></a>' +
				'<a id="dio_stone_'+dio_wndid+'_cult" class="dio_trade dio_send_cult" style="top:234px"></a>' +
				'<a id="dio_iron_'+dio_wndid+'_cult" class="dio_trade dio_send_cult" style="top:268px"></a>' +
                '</div>'
			);

			dio_wnd.find(".dio_send_cult").css({
				"right" : "84px",
				"position" : "absolute",
				"height" : "16px",
				"width" : "22px",
			...
			dio_wnd.find(".dio_send_cult_reverse").css({
				"left" : "105px",
				"position" : "absolute",
				"height" : "16px",
				"width" : "22px",
			...
			dio_wnd.find(".dio_trade").click(function () {
            ...
            // Tooltip
                ...
                $('.dio_send_cult').tooltip(dio_icon + getText("labels", "cityfestivals"));
                //$('.dio_send_cult_reverse').tooltip(getText("Quack", "delete"));
...
var JoeManCalculator = w.JoeManCalculator = {
	...
	Starten: Fehlerfunktion (function () {
		...
		JoeManCalculator.Button = Button_erstellen ("Calculator").css ({margin: "0px",padding: "0px 1px" , display: "block"}).click (JoeManCalculator.anzeigen).insertAfter (".bottom_ornament");
		JoeManCalculator.Element = $ ('<div class="sidebar_unit_container clearfix" style="color: #FFCC66; font-size: x-small; margin-bottom: 6px; padding-bottom: 6px; margin-left: 1px; background-position: right; background-image: url(https://i.imgur.com/nX02LYk.png);"></div>').appendTo (JoeManCalculator.Container);
	...
	anzeigen: Fehlerfunktion (function () {
		...
		if (JoeManCalculator.Container.is (":visible")) {
			...
			JoeManCalculator.Eingabe1_1 = $ ('<input type="text" value="00" style="background-color: #030356; color: #EAF53F; width: 16px;" />').on ("input", Eingabe.curry (1, 1)).appendTo (JoeManCalculator.Eingabe1);
			JoeManCalculator.Eingabe1.append (":");
			JoeManCalculator.Eingabe1_2 = $ ('<input type="text" value="00" style="background-color: #030356; color: #EAF53F; width: 16px;" />').on ("input", Eingabe.curry (1, 2)).appendTo (JoeManCalculator.Eingabe1);
			JoeManCalculator.Eingabe1.append (":");
			JoeManCalculator.Eingabe1_3 = $ ('<input type="text" value="00" style="background-color: #030356; color: #EAF53F; width: 16px;" />').on ("input", Eingabe.curry (1, 3)).appendTo (JoeManCalculator.Eingabe1);
			...
			JoeManCalculator.Eingabe2_1 = $ ('<input type="text" value="00" style="background-color: #030356; color: #EAF53F; width: 16px;" />').on ("input", Eingabe.curry (2, 1)).appendTo (JoeManCalculator.Eingabe2);
			JoeManCalculator.Eingabe2.append (":");
			JoeManCalculator.Eingabe2_2 = $ ('<input type="text" value="00" style="background-color: #030356; color: #EAF53F; width: 16px;" />').on ("input", Eingabe.curry (2, 2)).appendTo (JoeManCalculator.Eingabe2);
			JoeManCalculator.Eingabe2.append (":");
			JoeManCalculator.Eingabe2_3 = $ ('<input type="text" value="00" style="background-color: #030356; color: #EAF53F; width: 16px;" />').on ("input", Eingabe.curry (2, 3)).appendTo (JoeManCalculator.Eingabe2);
